...
def direct_prediction(data_train, data_test, feature_columns, target_column):
...
def component_prediction(data_train, data_test, feature_columns, year=2023, month=12):
...
def bucket_prediction(data_train, data_test, feature_columns, n_bins=10, year=2023, month=12):
...
def bayesian_prediction(data_train, data_test, feature_columns, target_column):
